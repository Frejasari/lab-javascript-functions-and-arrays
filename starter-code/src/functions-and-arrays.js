...
function averageNumbers(arrayOfNumbers) {
  ...
  //   return undefined;
  // }
  return arrayOfNumbers.length === 0 ? undefined : sumArray(arrayOfNumbers) / arrayOfNumbers.length;
}
...
function greatestProduct(matrix) {
  ...
  return greatestProduct > greatestProductVertical ? greatestProduct : greatestProductVertical;
}

function getProductFromCol(matrix, noOfFactors, colIndex = 0, startRowIndex = 0) {
...
var matrix = [[0, 2, 4, 2, 1], [3, 2, 1, 3, 2], [0, 2, 4, 2, 1], [0, 2, 4, 2, 1], [0, 2, 4, 2, 1]];
...
var matrix = [
  ...
  [22, 31, 16, 71, 51, 67, 63, 89, 41, 92, 36, 54, 2, 40, 40, 28, 66, 33, 3, 8],
